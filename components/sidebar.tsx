...
const items = [
  ["🏠", "Início", "/dashboard"],["📦", "Pedidos", "/pedidos"],["📅", "Calendário", "/calendario"],["💰", "Financeiro", "/financeiro"],["🛒", "Gastos e compras", "/gastos-e-compras"],["📦", "Estoque", "/estoque"],["🎨", "Receita de pintura", "/receita-de-pintura"],["🚚", "Enviados", "/enviados"],["✅", "Finalizados", "/finalizados"],["👥", "Clientes", "/clientes"],["🧰", "Produtos", "/produtos"],["🖨️", "Impressoras", "/impressoras"],["⚙️", "Configurações", "/configuracoes"],
] as const;
