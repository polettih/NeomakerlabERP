...
export function CreatePaintingRevenueForm() {
  const r = useRouter();
  ...
  async function submit(e: FormEvent) {
    e.preventDefault();
    setError("");
    const res = await fetch("/api/painting-revenues", {
      method: "POST",
      ...
      body: JSON.stringify({
        ...
        painting_date: date || new Date().toISOString(),
      }),
    });
    ...
    <form onSubmit={submit} className="card grid">
      ...
      <div className="field">
        ...
        <input
          ...
          required
          placeholder="Pintura de action figure"
        />
      </div>
      <div className="field">
        <label>Cliente</label>
