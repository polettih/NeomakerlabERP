...
export default async function GastosPage(){
 ...
 const [{data:materials},{data:expenses}]=await Promise.all([
 ...
 const stockValue=(materials??[]).reduce((s,m)=>s+Number(m.quantity_on_hand||0)*Number(m.average_cost||0),0);
